...
export const IMPORTED_HTML_CUSTOM_VIDEO_RULES: readonly string[]
export const IMPORTED_HTML_CUSTOM_VIDEO_SKELETON: string
...
export function buildImportedHtmlCustomVideoRulesText(heading?: string): string
