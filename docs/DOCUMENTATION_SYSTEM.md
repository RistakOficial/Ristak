...
| Enrutamiento entre MCP funcional, operaciones remotas y soporte interno; investigacion de clientes instalados via Installer | `docs/support-mcp-operations.md` |
