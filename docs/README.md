...
| Como elegir entre MCP funcional, operaciones remotas de clientes y soporte; revisar clientes, logs, chats, DB e IA instalada | [support-mcp-operations.md](./support-mcp-operations.md) |
...
| Enrutamiento entre MCP funcional, puente operativo y soporte interno via Ristak Installer | [support-mcp-operations.md](./support-mcp-operations.md) |
