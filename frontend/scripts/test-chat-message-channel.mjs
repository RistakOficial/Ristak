...
assert.equal(getChatBubbleColorChannel('email'), undefined)
assert.equal(getChatBubbleColorChannel('sms'), undefined)
assert.equal(getChatBubbleColorChannel('whatsapp_api'), 'whatsapp_api')
assert.equal(getChatBubbleColorChannel('whatsapp_qr'), 'whatsapp_qr')
