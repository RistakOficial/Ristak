...
export const Reports: React.FC = () => {
  ...
  const reportContactsModalData = useMemo(() => (
    modalState.contacts.map(contact => ({
      ...
      referredByContact: contact.referredByContact,
      attributionContactId: contact.attributionContactId,
      attributionContactName: contact.attributionContactName,
      attributionInheritedFromReferral: contact.attributionInheritedFromReferral,
