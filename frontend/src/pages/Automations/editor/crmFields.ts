...
export const TRIGGER_FILTER_FIELDS: TriggerFilterField[] = [
  ...
  { id: 'clip_payment_id', label: 'CLIP payment ID', phrase: 'el payment ID de CLIP', category: 'Pasarela de pago', appliesTo: ['payment'] },
  { id: 'clip_receipt_no', label: 'CLIP receipt no.', phrase: 'el recibo de CLIP', category: 'Pasarela de pago', appliesTo: ['payment'] },
  { id: 'rebill_payment_id', label: 'Rebill payment ID', phrase: 'el payment ID de Rebill', category: 'Pasarela de pago', appliesTo: ['payment'] },
  { id: 'rebill_subscription_id', label: 'Rebill subscription ID', phrase: 'la subscription ID de Rebill', category: 'Pasarela de pago', appliesTo: ['payment'] },
  { id: 'rebill_customer_id', label: 'Rebill customer ID', phrase: 'el customer ID de Rebill', category: 'Pasarela de pago', appliesTo: ['payment'] },
  { id: 'rebill_card_id', label: 'Rebill card ID', phrase: 'la card ID de Rebill', category: 'Pasarela de pago', appliesTo: ['payment'] },
