...
// - otra fecha -> mediodía LOCAL de ese día (cae en el día correcto en la zona del usuario,
//                 incluso en zonas extremas UTC-12..UTC+14, sin correrse de día)
export const buildPaymentTimestamp = (dateInput?: string | null): string => {
  const now = new Date()
