...
test('embedded plan features cannot leak through contacts, chat, notifications, or iPhone', async () => {
  ...
  assert.match(paymentsConfiguration, /const hasPaymentAutomationsAccess = hasLicenseFeature\(user, \['payment_automations'\]\)/)
  assert.match(paymentsConfiguration, /const hasPaymentCheckoutAccess = hasLicenseFeature\(user, \['payment_checkout'\]\)/)
  assert.match(paymentsConfiguration, /const hasPaymentGatewaysAccess = hasLicenseFeature\(user, \['payment_gateways'\]\)/)
