...
test('las migraciones con sufijo de dialecto sólo apuntan a su motor', () => {
  ...
  assert.equal(migrationRunsForDialect('165_appointment_booking_origin.sqlite.sql', 'sqlite'), true)
  assert.equal(migrationRunsForDialect('165_appointment_booking_origin.sqlite.sql', 'postgres'), false)
  assert.equal(migrationRunsForDialect('165a_appointment_booking_origin.postgres.sql', 'postgres'), true)
  assert.equal(migrationRunsForDialect('165a_appointment_booking_origin.postgres.sql', 'sqlite'), false)
