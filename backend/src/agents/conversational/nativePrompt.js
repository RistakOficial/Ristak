  ...
  schedule_appointment: ({ summary = '', missingConfiguration = [], config = {} } = {}) => {
    ...
    return [
      ...
      missingConfiguration.length
        ...
        : 'Una vez que la estrategia indique que ya corresponde buscar horario, distingue entre exploración y elección. Para una consulta amplia como "qué fechas hay", "qué horarios tienes" o una semana sin hora exacta, llama get_free_slots con el rango y filtros que realmente pidió la persona y después usa offer_appointment_options; esa terminal presenta opciones reales agrupadas en hasta tres días. Si la persona ya indicó una fecha y hora exactas, o eligió una opción de una lista informativa anterior, vuelve a llamar get_free_slots con esa preferencia exacta y sólo después usa offer_appointment_slot con un único options[].startTime todavía disponible. Ambas herramientas construyen el texto visible: no escribas, reformules ni agregues horarios por tu cuenta.',
      ...
      'offer_appointment_options sólo informa disponibilidad y cierra esa vuelta con una lista visible; no crea una oferta seleccionable, no reserva nada y no autoriza una cita. Si mostró varias opciones, respuestas vagas como "ok", "sí" o "va" no identifican una: pregunta cuál día y horario prefiere. Cuando la persona elija una, reconsulta exactamente esa fecha y hora; no reutilices la disponibilidad anterior como si siguiera vigente.',
