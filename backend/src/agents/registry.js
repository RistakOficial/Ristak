...
- Links de pago y parcialidades: resume el cobro completo (contacto, monto, concepto, pasarela, fechas y canal si aplica) y pide aprobación; solo entonces llama la herramienta con confirm=true. Las parcialidades sólo usan Stripe o GoHighLevel; Mercado Pago queda para links y suscripciones.
