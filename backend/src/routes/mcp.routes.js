...
const SENSITIVE_TABLE_PATTERN = /^(users|user_invitations|payment_methods|highlevel_config|meta_config|meta_oauth_integrations|meta_oauth_integration_sessions|meta_oauth_pending_sessions|meta_oauth_connection_backups|meta_oauth_authorized_assets|meta_campaign_templates|meta_campaign_drafts|meta_campaign_execution_logs|ai_agent_config|agent_runs|agent_steps|agent_pending_actions|agent_tool_idempotency|app_config|oauth_clients|oauth_authorization_codes|oauth_refresh_tokens|oauth_grants|mcp_idempotency_keys|mcp_audit_log|mcp_action_confirmations|mcp_business_events|mcp_event_acknowledgements|site_video_metric_lineage|site_video_replacements|conversational_agent_goal_links|conversational_agent_goal_evidence_claims)$/i
...
const MCP_SERVER_INSTRUCTIONS = [
  ...
  'Antes de llamar sites_replace_video, pregunta siempre si la persona quiere conservar las métricas anteriores o empezar desde cero; nunca infieras metricsMode.',
...
async function listDataTables() {
  ...
  return {
    ...
    blockedTables: ['users', 'user_invitations', 'payment_methods', 'highlevel_config', 'meta_config', 'meta_oauth_integrations', 'meta_oauth_integration_sessions', 'meta_oauth_pending_sessions', 'meta_oauth_connection_backups', 'meta_oauth_authorized_assets', 'meta_campaign_templates', 'meta_campaign_drafts', 'meta_campaign_execution_logs', 'ai_agent_config', 'agent_runs', 'agent_steps', 'agent_pending_actions', 'agent_tool_idempotency', 'app_config', 'oauth_clients', 'oauth_authorization_codes', 'oauth_refresh_tokens', 'oauth_grants', 'mcp_idempotency_keys', 'mcp_audit_log', 'mcp_action_confirmations', 'mcp_business_events', 'mcp_event_acknowledgements', 'site_video_metric_lineage', 'site_video_replacements', 'conversational_agent_goal_links', 'conversational_agent_goal_evidence_claims'],
