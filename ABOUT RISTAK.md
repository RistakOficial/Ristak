...
- Tokens de HighLevel y Meta se configuran desde Settings. Stripe puede configurarse manualmente desde Settings o por Stripe Connect OAuth usando credenciales de plataforma en `.env`.
